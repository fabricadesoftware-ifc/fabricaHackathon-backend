# Generated by Django 5.0.4 on 2024-07-16 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members_per_team', models.IntegerField(blank=True, null=True)),
                ...
                ('involved_classes', models.ManyToManyField(to='hackathon.classinfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkedin', models.URLField(blank=True, null=True)),
                ('instagram', models.URLField(blank=True, null=True)),
                ('classInfo', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='hackathon.classinfo', verbose_name='class')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apresentation_link', models.URLField(blank=True, null=True)),
                ...
                ('leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='leader', to='hackathon.student')),
